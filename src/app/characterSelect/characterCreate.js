...
function handleSexSelect(evt, setCharacterSex) {
  setCharacterSex(evt.target.value)
}

function handleCharacterName(evt, setCharacterName) {
    ...
    return(
      <div className="flex justify-center">
        <div className="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem] text-white font-bold">
          <input
            onChange={(evt) => {handleSexSelect(evt, setCharacterSex)}}
...
async function submitCharacter(event, router, characterName, characterSex) {
...
const CharacterCreate = ({router}) => {
    ...
    return(
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-white text-center pb-4">What shall we call you?</h1>
          <form onSubmit={(event) => {submitCharacter(event, router, characterName, characterSex)}} className="flex flex-col items-center">
            <input
              onChange={(evt) => {handleCharacterName(evt, setCharacterName)}}
              type="text"
              name="name"
              id="name"
...
export default memo(CharacterCreate)